...
class Logger:
    def __init__(self, rep_counter='', v=None):
        ...
        if v.PrivateV.private:
            log_file_name = os.path.join(v.PathV.log_path, cntstr + v.PathV.date + '_' + str(v.SampCompV.max_iter) + '.log')
        else:
        ...
        if v.PrivateV.private:
            log_file_name = os.path.join(v.PathV.log_path, cntstr + v.PathV.date + '_' + str(v.SampCompV.max_iter) + '_weights.log')
        else:
