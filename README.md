...
This project is a simulation of Subsample-Test-Reweigh algorithm. The simulation and the results are described in the paper: "Transfer Learning In Differential Privacy's Hybrid-Model", Refael Kohen<sup>1</sup>, Or Sheffet<sup>1</sup>
(accepted to International Conference of Machine Learning (ICML) - 2022).

<sup>1</sup> Faculty of Engineering|, Bar-Ilan University - Israel
...
The code of the simulation has been written by Refael Kohen: refael.kohen@gmail.com under the supervision of Dr. Or Sheffet or.sheffet@biu.ac.il.
